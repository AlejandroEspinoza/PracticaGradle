package com.android.training.zoologico.china;
 ...
 */
public class PrincipalDebugChina extends AppCompatActivity  {
    ...
    private void fillInterface(){
        ...
        icono          .setBackground(ContextCompat.getDrawable(this, R.drawable.panda_china));
    }
}
